...
const newsArticles: NewsArticle[] = [
  {
    ...
    excerpt: "Onze innovatieve aanpak van duurzaam design erkend op het internationale podium.",
    content:
  ...
  },
  {
    ...
    excerpt: "De Minimalist Villa project is nu officieel voor bewoners opengesteld.",
    content:
  ...
  },
  {
    ...
    excerpt: "Studio Architecten spotlight in leading architecture publication.",
    content:
  ...
  },
  {
    ...
    excerpt: "Announcing our commitment to carbon-neutral design practices by 2025.",
    content:
  ...
  },
  {
    ...
    excerpt: "Strategic partnership announced with leading European architecture firms.",
    content:
...
const categories = ["Alle Nieuws", "Awards", "Projects", "Press", "Sustainability", "Company", "Partnerships"]
    ...
    <section className="py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {featuredArticles.length > 0 && (
          <div className="mb-16">
            <h2 className="text-2xl font-light tracking-tight mb-8">Uitgelicht</h2>
        ...
        {regularArticles.length > 0 && (
          <div>
            <h2 className="text-2xl font-light tracking-tight mb-8">Meer Nieuws</h2>
