  ...
  return (
    <section className="py-24 px-6 bg-primary text-primary-foreground">
      <div className="max-w-3xl mx-auto text-center">
        <p className="text-sm font-light tracking-widest opacity-70 mb-6">
        ...
        <p className="text-lg font-light opacity-70 mb-12">
          Neem contact met ons op en ontdek hoe Architectenbureau Paul Kindt uw
          visie kan realiseren met innovatief design en vakmanschap.
        </p>
        <Link
          href="/contact"
