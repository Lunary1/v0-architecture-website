  ...
  return (
    <section className="py-24 px-6 border-t border-gray-200">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-12 border-t border-b border-gray-200">
          <div>
            <p className="text-4xl font-light mb-2">500+</p>
            <p className="text-sm font-light text-gray-600 tracking-wide">Projecten Voltooid</p>
          </div>
          <div>
            <p className="text-4xl font-light mb-2">25+</p>
            <p className="text-sm font-light text-gray-600 tracking-wide">Jaren Ervaring</p>
          </div>
          <div>
            <p className="text-4xl font-light mb-2">50+</p>
            <p className="text-sm font-light text-gray-600 tracking-wide">Team Leden</p>
          </div>
          <div>
            <p className="text-4xl font-light mb-2">15+</p>
            <p className="text-sm font-light text-gray-600 tracking-wide">Awards Gewonnen</p>
          </div>
        </div>
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="w-12 h-12 bg-black text-white flex items-center justify-center rounded-full mb-4 font-light">
                1
              </div>
